...
namespace WindowsRegistry_07
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var val3 = key.GetSubKeyNames();
            foreach (var v in val3)
            {
                Console.WriteLine("Subkey Name : " + v);
            }
            Console.WriteLine("------------------------------------------------------------------------------------------");

            var val4 = key.GetValueNames();
            foreach (var v in val4)
            {
                Console.WriteLine("Values Name : " + v);
            }
            Console.WriteLine("------------------------------------------------------------------------------------------");
